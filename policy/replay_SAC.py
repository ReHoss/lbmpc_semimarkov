...
SelfReplaySAC = TypeVar("SelfReplaySAC", bound="ReplaySAC")
...
class ReplaySAC(SAC):
    def __init__(self, policy, env, horizon,
                 ...
                 learning_rate = 0.0003, buffer_size = 1000000, learning_starts = 100, batch_size = 256, 
                 tau = 0.005, gamma = 0.99, train_freq = 1, gradient_steps = 1, action_noise = None, 
                 ...
                 use_sde_at_warmup = False, stats_window_size = 100, tensorboard_log = None, policy_kwargs = None, 
    ...
    def learn(self: SelfReplaySAC, 
              total_timesteps: int, 
              callback: MaybeCallback = None, 
              log_interval: int = 4, 
              tb_log_name: str = "ReplaySAC", 
              reset_num_timesteps: bool = True, 
              progress_bar: bool = False) -> SelfReplaySAC:
