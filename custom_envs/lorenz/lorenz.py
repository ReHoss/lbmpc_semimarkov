"""
Gymnaium environment for the Lorenz system.

TODO:
- Implement the index target equilibrium point
"""
...
class LorenzEnv(pde_class.EnvPDE):
    ...
    def __init__(self,
        ...
        _infty_bound = 10e2  # This quantity is a placeholder for infinity, because of the Gym version used in SB3.
...
def main() -> None:
    """Create an instance of the environment and check it fits the requirements of stable-baselines3.

    The environment is created then checked with the check_env function of stable-baselines3.
    ...
    env = LorenzEnv(**dict_env_parameters)
    # It will check your custom environment and output additional warnings if needed
    print(f"\nEnvironment checker output: {env_checker.check_env(env)}\n")
