...
def kern_exp_quad_ard(xmat1, xmat2, ls, alpha):
    ...
    xmat2 = np.expand_dims(xmat2, axis=0)  # INFO @REMY: warning, those array shapes are not documented
    diff = xmat1 - xmat2
    diff /= ls
...
def gp_post(x_train, y_train, x_pred, ls, alpha, sigma, kernel, full_cov=True):  #INFO @REMY: there is a similar method in SimpleGP object, here it is a function that is designed ...
