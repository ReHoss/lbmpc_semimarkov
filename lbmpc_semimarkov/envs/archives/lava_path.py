...
class ShortLavaPathEnv(LavaPathEnv):
    ...
    def step(self, action):
        ...
        o1, r1, te1, tr1, i1 = super().step(action)
        o2, r2, te2, tr2, i2 = super().step(action)
        return o2, r2, te2, tr2, i2
...
def test_lava_path():
    ...
    for _ in range(env.horizon):
        action = env.action_space.sample()
        n, r, terminated, truncated, info = env.step(action)
        done = terminated or truncated
        if done:
            break
    print("passed")
